...
(function() {
  ...
  Star.LeftPanel = (function(_super) {

    __extends(LeftPanel, _super);

    function LeftPanel() {
      this.onNavItemlick = __bind(this.onNavItemlick, this);
      return LeftPanel.__super__.constructor.apply(this, arguments);
    }

    LeftPanel.prototype.el = $("#left-panel");

    LeftPanel.prototype.initialize = function(option) {
      this.option = option;
      return LeftPanel.__super__.initialize.call(this, this.option);
    };

    LeftPanel.prototype.events = {
      "click a": 'onNavItemlick'
    };

    LeftPanel.prototype.onNavItemlick = function(e) {
      return this.option.eventBus.trigger('changeView', e.target.href);
    };
...
(function() {
  ...
  Star.RightPanel = (function(_super) {
    ...
    RightPanel.prototype.el = $("#right-panel");

    RightPanel.prototype.initialize = function(option) {
      this.option = option;
      RightPanel.__super__.initialize.call(this, this.option);
      return this.initEvent();
    };

    RightPanel.prototype.initEvent = function() {
      var _this = this;
      return this.option.eventBus.on('changeView', function(e) {
        return _this.$('#right-panel-header').html(e);
      });
    };
...
// Generated by CoffeeScript 1.4.0
(function() {
  var LeftPanel, RightPanel, leftPanel, rightPanel;
